	...
	return (
		<article className="rounded-3xl border border-zinc-200 bg-white p-4 shadow-sm">
			<div className="flex items-start justify-between">
				<div>
					<p className="text-xs text-zinc-500">Cycle day</p>
					<p className="text-2xl font-semibold text-zinc-900">{cycleDay}</p>
				</div>
				<span className="rounded-full bg-rose-50 px-3 py-1 text-xs font-medium text-rose-700">
					{phaseLabel[phase]}
				</span>
			</div>
			<p className="mt-2 text-xs text-zinc-600">{phaseCopy[phase]}</p>
			<div className="mt-2 rounded-2xl bg-zinc-50 px-3 py-2 text-xs text-zinc-600">
};
